...
const rawTasks = `201	Pipe	MD Sir	Kamal Sharma 65-18	हर महिने की 1 तारिख को Printing Machine का UPS Check करना है।	01/08/2025 18:00:00	monthly	Yes	No
202	Pipe	MD Sir	Kamal Sharma 65-18	हर महिने की 5 तारीख को Compressor Machine (Atlas)का Maintenance Check करना है।	05/08/2025 18:00:00	monthly	Yes	No
203	Pipe	MD Sir	Kamal Sharma 65-18	हर महिने की 5 तारीख को Compressor Machine (LG)का Maintenance Check करना है।	05/08/2025 18:00:00	monthly	Yes	No
204	Pipe	MD Sir	Kamal Sharma 65-18	हर रविवार को 52/18 Machine की सफाई करवाना है।	12/07/2025 18:00:00	weekly	Yes	No
205	Pipe	MD Sir	Kamal Sharma 65-18	हर रविवार को 65/18 Machine की सफाई करवाना है।	12/07/2025 18:00:00	weekly	Yes	No
206	Pipe	MD Sir	Kamal Sharma 65-18	हर रविवार को तीनों Printing Machine सफाई करवाना है।	12/07/2025 18:00:00	weekly	Yes	No
216	Pipe	MD Sir	Kamal Sharma 65-18	हर 6 महिने में 52/18 Machine का Hopper Paint करवाना है।	01/01/2026 18:00:00	half yearly	Yes	No
217	Pipe	MD Sir	Kamal Sharma 65-18	हर 6 महिने में 52/18 Machine का Greasing करवाना है।	01/01/2026 18:00:00	half yearly	Yes	No
218	Pipe	MD Sir	Kamal Sharma 65-18	हर 6 महिने में 65/18 Machine का Hopper Paint करवाना है।	01/01/2026 18:00:00	half yearly	Yes	No
219	Pipe	MD Sir	Kamal Sharma 65-18	हर 6 महिने में 65/18 Machine का Greasing करवाना है।	01/01/2026 18:00:00	half yearly	Yes	No
220	Pipe	MD Sir	Kamal Sharma 65-18	हर 6 महिने में Grinder का Plate धार करवाना है।	01/01/2026 18:00:00	half yearly	Yes	No`;
...
function generateDates(originalDateString, frequency) {
  ...
  switch (frequency.toLowerCase()) {
    ...
    case "half yearly": {
      ...
      // Setup the initial start month corresponding to the source start date, but incremented to align within range
      cur.setMonth(orig.getMonth());
      cur.setFullYear(START_DATE.getFullYear()); // jump to range start

      if (cur < START_DATE) cur.setMonth(cur.getMonth() + 6);
      if (cur < START_DATE) cur.setMonth(cur.getMonth() + 6);
      ...
      while (cur <= END_DATE) {
        ...
        cur.setMonth(cur.getMonth() + 6); // Add strictly 6 months per jump
      }
      break;
    }
  }
...
async function run() {
  ...
  console.log("Inserting base templates for Kamal's tasks...");
