...
const rawTasks = `187	Pipe	MD Sir	Santosh Das 52-18	Bend Check करना है।	12/07/2025 18:00:00	daily	Yes	No
188	Pipe	MD Sir	Santosh Das 52-18	Finish Goods Store में Pipe सही जगह सेट कराना है।	12/07/2025 18:00:00	daily	Yes	No
189	Pipe	MD Sir	Santosh Das 52-18	Grinding Material Weight Check करना है।	09/07/2025 18:00:00	daily	Yes	No
190	Pipe	MD Sir	Santosh Das 52-18	Pipe Weight करना है।	12/07/2025 18:00:00	daily	Yes	No
191	Pipe	MD Sir	Santosh Das 52-18	Pulverize Material Weight Check करना है।	09/07/2025 18:00:00	daily	Yes	No
192	Pipe	MD Sir	Santosh Das 52-18	Raw Material को सहीं जगह पर रखना है।	09/07/2025 18:00:00	daily	Yes	No
193	Pipe	MD Sir	Santosh Das 52-18	मटेरियल ठेले में रख के नहीं छोड़ेंगे	12/07/2025 18:00:00	daily	Yes	No
194	Pipe	MD Sir	Santosh Das 52-18	हर 3 महीनें में Freezing Powder Weight करना है।	01/10/2025 18:00:00	quarterly	Yes	No
195	Pipe	MD Sir	Santosh Das 52-18	हर 3 महीनें में पानी की टंकी साफ करना है।	01/10/2025 18:00:00	quarterly	Yes	No
196	Pipe	MD Sir	Santosh Das 52-18	हर सोमवार को मशीन में Heat देना है।	14/07/2025 18:00:00	weekly	Yes	No
260	Pipe	MD Sir	Santosh Das 52-18	Printing Machine की सफाई हुआ है या नहीं चेक करके फोटो डालना है	25/09/2025 18:00:00	daily	Yes	Yes
261	Pipe	MD Sir	Santosh Das 52-18	65/18 machine की सफाई हुआ है या नहीं चेक करके फोटो डालना है	25/09/2025 18:00:00	daily	Yes	No
262	Pipe	MD Sir	Santosh Das 52-18	52/18 machine की  सफाई हुआ है या नहीं चेक करके फोटो डालना है	25/09/2025 18:00:00	daily	Yes	No
263	Pipe	MD Sir	Santosh Das 52-18	Cashing machine की सफाई हुआ है या नहीं चेक करके फोटो डालना है	25/09/2025 18:00:00	daily	Yes	No
314	Pipe	MD Sir	Santosh Das 52-18	production paper by 11 am	30/10/2025 11:00:00	daily	Yes	No`;
...
function generateDates(originalDateString, frequency) {
  ...
  switch (frequency.toLowerCase()) {
    ...
    case "quarterly": {
      const targetDay = orig.getDate();
      const targetMonthMod = orig.getMonth() % 3; // 0, 1, or 2 to maintain the quarterly cadence
      ...
      while (cur <= END_DATE) {
        // Only generate for months that fit the 3 month rotation matching the original start date
        if (cur.getMonth() % 3 === targetMonthMod) {
          const maxDay = new Date(
            cur.getFullYear(),
            cur.getMonth() + 1,
            0,
...
async function run() {
  ...
  console.log("Inserting base templates for Santosh's tasks...");
