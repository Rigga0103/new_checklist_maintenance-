            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50 dark:bg-zinc-950/50">
                <tr className="border-b border-gray-200 dark:border-zinc-800">
                  ...
                  <th className="text-left p-3 font-semibold text-gray-700 dark:text-gray-300">Required For</th>
                  <th className="text-left p-3 font-semibold text-gray-700 dark:text-gray-300">Quantity</th>
              ...
              <tbody>
                {requests.map((request) => (
                  ...
                  >
                    ...
                    <td className="p-3">
                      <div className="max-w-[200px] truncate text-sm text-gray-700 dark:text-gray-300" title={request.required_for}>
